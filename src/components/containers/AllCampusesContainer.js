...
import { fetchAllCampusesThunk, deleteCampusThunk, createCampusThunk } from "../../store/thunks";
    ...
    return (
      <div>
        ...
        <AllCampusesView
          ...
          createCampus={this.props.createCampus}
        />
      </div>
    );
  }
...
const mapDispatch = (dispatch) => {
  return {
    ...
    createCampus: (campus) => dispatch(createCampusThunk(campus))
  };
};
